...
public class BundleExample
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // BaselineSubstituteBuilder subsBuilder = new BaselineSubstituteBuilder(indexPath, 100,
        // true);
        ...
        // List<SubstituteVector> substitutes = subsBuilder.getSubstitutes("Hallo , heute ist das
        // Wetter besonders gut ");

        SubstituteLookup sl = new SubstituteLookup(indexPath, 100);
        List<SubstituteVector> bundle = sl.getBundle(4, "gegeben", "VVPP");
